...
const PlacementGuide = () => {
  return (
    <Container style={{margin: '13px', marginTop:'20px', marginRight:'20px'}}>
      ...
      <Box mb={4}>
        ...
        <Link href="https://dev.to/avinash201199/how-to-ask-for-a-referral-on-linkedin-1g7e" target="_blank">📌How to ask referral on Linkedin</Link>
      </Box>
